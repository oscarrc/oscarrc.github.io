...
And that's basically it, just add some [framer-motion](https://www.framer.com/docs/animation/) animations to make it look fancy, and here you have it, and awesome and simple portfolio made with React and MDX and hosted with Github pages.
