...
GB Cam has implemented all the functions of the original like image flipping, palette variations and dithering factor, as well as 18 built-in frames for the picture.
