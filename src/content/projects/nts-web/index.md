---
title: NTS-web
description: A comprehensive web-based controller, editor, and sequencer for the Korg NTS-1 synthesizer, built with React and Web MIDI API. Features patch management, real-time parameter control, and cross-platform compatibility through PWA technology and Electron packaging.
cover: 
