...
If our web complies with this requiriments we are good to know.


## Installing Bubblewrap

To install Bubblewrap we need to have node.js and npm installed on our system. If we have it is as simple as run:
